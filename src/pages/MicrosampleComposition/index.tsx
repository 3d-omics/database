...
const MicrosampleComposition = ({ cryosectionFromTab = '' }) => {

  const { cryosection: cryosectionFromParams = '' } = useParams()
  const cryosection = cryosectionFromTab || cryosectionFromParams
