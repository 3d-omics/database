export const menus = [
  {
    sectionTitle: 'Animal Trial/Experiment',
    subMenus: [
      { location: '/animal-trial-experiment', title: 'Animal Trial/Experiment' },
...

  {
    ...
    subMenus: [
      { location: '/intestinal-section-sample', title: 'Intestinal Section Sample' },
...

  {
    ...
    subMenus: [
      ...
      { location: '/microsample-composition', title: 'Genome Composition' },
    ]
  }
]
